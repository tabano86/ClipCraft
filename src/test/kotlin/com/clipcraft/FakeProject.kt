...
class FakeProject(private val path: String) : Project {
    ...
    override fun createError(message: String, error: Throwable?, pluginId: PluginId, attachments: MutableMap<String, String>?) = throw UnsupportedOperationException()
...
open class FakeVirtualFile(private val filePath: String, private val fileContent: String, private val isDir: Boolean = false) : VirtualFile() {
...
object FakeVirtualFileSystem : VirtualFileSystem() {
    ...
    override fun createChildFile(requestor: Any?, vDir: VirtualFile, fileName: String) = throw UnsupportedOperationException()
    override fun createChildDirectory(requestor: Any?, vDir: VirtualFile, dirName: String) = throw UnsupportedOperationException()
    override fun copyFile(requestor: Any?, virtualFile: VirtualFile, newParent: VirtualFile, copyName: String) = throw UnsupportedOperationException()
