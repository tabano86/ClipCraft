Below is an example `CODE_OF_CONDUCT.md` file tailored for ClipCraft. It’s adapted from the Contributor Covenant to help foster an inclusive and respectful community:
